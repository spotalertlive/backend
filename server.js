...
// CORE signup handler (used by multiple routes)
...
// ORIGINAL route that worked with your frontend
app.post("/api/signup", handleSignup);

// EXTRA compatibility route in case frontend calls /api/auth/signup
app.post("/api/auth/signup", handleSignup);

// CORE login handler (used by multiple routes)
...
// ORIGINAL path your old frontend used
app.post("/api/auth/login", handleLogin);

// EXTRA compatibility route in case some JS still calls /api/login
app.post("/api/login", handleLogin);

// Password reset: generates token & logs it – later you can email it
app.post("/api/auth/request-reset", async (req, res) => {
  try {
    ...
    // Later: email this token using SES.
...
// =======================================================
// PLANS + USAGE SUMMARY (used by plans.js, dashboard.js)
// =======================================================
